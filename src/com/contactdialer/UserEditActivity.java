...
public class UserEditActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((EditText) item.findViewById(R.id.value)).setInputType(InputType.TYPE_CLASS_TEXT);
	...
	private void updateUser() {
		...
		String country=NumberConverter.CHINA;
		...
		String mobilePrefix=NumberConverter.MOBILEPREFIX;
		
		user.set(name, country, district, group, inGroup, outGroup, mobilePrefix);
		if (mode==MODE_EDIT) {
